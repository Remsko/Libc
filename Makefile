...
SRC_SUB += rb_tree
SRC_NAME += rb_tree_getters.c
SRC_NAME += rb_tree_insert_cases.c
SRC_NAME += rb_tree_insertion.c
SRC_NAME += rb_tree_rotations.c
SRC_NAME += rb_tree_deletion.c
SRC_NAME += rb_tree_delete_cases.c
